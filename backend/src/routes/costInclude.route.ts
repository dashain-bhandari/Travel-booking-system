...
import { createCostIncludeHandler, updateCostIncludeHandler, getCostIncludeHandler, getAllCostIncludeHandler, deleteCostIncludeHandler, getCostIncludeByExpeditionHandler, deleteManyCostIncludeHandler } from "../controller/costInclude.controller";
...
router.post("/", [validate(createCostIncludeSchema), requireAdmin], createCostIncludeHandler);
...
router.delete("/:costIncludeId", [validate(deleteCostIncludeSchema), requireAdmin], deleteCostIncludeHandler);
