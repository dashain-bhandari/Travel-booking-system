...
import { createIternaryHandler, updateIternaryHandler, getIternaryHandler, getAllIternaryHandler, deleteIternaryHandler, getIternaryByExpeditionHandler, deleteManyIternaryHandler } from "../controller/iternary.controller";
