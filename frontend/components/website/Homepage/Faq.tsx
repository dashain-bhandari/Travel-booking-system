...
export default function Faq({}: Props) {
  ...
  return (
    <div className="w-full py-[5rem]  relative">
      ...
      {/* top title  */}
      <div className="flex w-11/12 mx-auto 4xl:w-10/12  justify-center items-center text-center flex-col gap-3">
        {/* title  */}
        <motion.div
        ...
        >
          <h1 className="text-3xl home-faq-title title uppercase text-secondary-500 text-center  font-bold">
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: false, amount: 0.3 }}
          className="w-full md:w-[50%] home-faq-desc text-secondary-300"
        >
