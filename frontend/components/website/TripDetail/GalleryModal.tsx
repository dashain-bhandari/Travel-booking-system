...
interface NewGalleryProps {
  media: any[];
  setOpenGalleryModal: React.Dispatch<React.SetStateAction<boolean>>; // Adjust the type of `media` based on its structure
}

const NewGallery = ({ media, setOpenGalleryModal }: NewGalleryProps) => {
            ...
            <div className="lg:w-[60%] md:w-[60%] sm:w-[100%] xs:w-[100%] 4xl:w-12/12 mx-auto">
              <div className="grid grid-cols-12 gap-2">
                ...
                <div className="col-span-12 md:col-span-12 h-[35rem]  relative">
                  {media.length > 0 ? (
                    <img
                      src={media[0].media} // The main image
                      alt="Main"
