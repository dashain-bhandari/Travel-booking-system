...
import { createMediaHandler, getMediaHandler, deleteMediaHandler, getMediaByExpeditionHandler, updateMediaHandler, deleteManyMediaHandler } from "../controller/media.controller";
...
router.post("/", [validate(createMediaSchema),requireAdmin], createMediaHandler);
/**
 * @swagger
 * /medias/{mediaId}:
 *   patch:
...
router.delete("/:mediaId", [validate(deleteMediaSchema),requireAdmin], deleteMediaHandler);
