...
import { createCostInclude, deleteCostInclude, deleteManyCostInclude, findAllCostInclude, findAndUpdateCostInclude, findCostInclude, findCostIncludeByExpedition } from "../service/costInclude.service";
...
export async function deleteManyCostIncludeHandler(req: Request, res: Response, next: NextFunction) {
  try {
    console.log("hii")
   if(req.body.id){
