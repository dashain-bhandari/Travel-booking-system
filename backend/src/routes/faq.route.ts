...
import { createFaqHandler, updateFaqHandler, getFaqHandler, getAllFaqHandler, deleteFaqHandler, getFaqByExpeditionHandler, deleteManyFaqHandler } from "../controller/faq.controller";
...
router.post("/", [ validate(createFaqSchema),requireAdmin], createFaqHandler);
