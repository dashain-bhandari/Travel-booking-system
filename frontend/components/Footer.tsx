  ...
  return (
    <div className="w-full bg-[#1E1E1E] overflow-x-hidden relative">
      ...
      <div className="h-full mx-auto  py-9  relative">
        ...
        />
        <div className="w-11/12 4xl:w-10/12  mx-auto grid md:grid-cols-6 py-3 relative place-items-start gap-5">
          <div className="flex w-full flex-col gap-5 col-span-2">
            <Image alt="contour-logo" src={Logo} className="w-[8rem]"></Image>
            {/* social icon  */}
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-1">
                <span className="font-medium text-zinc-100">Address</span>
              ...
              <div className="flex justify-start flex-wrap gap-5 mt-5 items-start">
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-nowrap text-zinc-300 title text-sm font-semibold items-center">
                    We accept:
                  </span>{" "}
                  <Image
                    src={PaymentImg}
          ...
          <div className="w-full flex flex-col gap-5 justify-center items-start">
            <h1 className="font-semibold text-lg text-zinc-50">Company</h1>
              ...
              {CompanyLinks.map((link, index) => (
                ...
                >
                  <div className="flex flex-col">
                    <Link href={link.href}>
                      <span className="font-medium mb-2">{link.name}</span>
                    </Link>
                  </div>
                </span>
              ))}
          ...
          {nestedData &&
            nestedData.slice(0, 2).map((collection: any) => (
              ...
              >
                <h1 className="font-semibold text-lg text-zinc-50">
                  {collection.name}
                </h1>
                <div className="flex flex-col  gap-2 text-sm">
        ...
        <div className="mx-auto md:mt-[-5%]  w-11/12 relative md:w-5/12 grid  grid-cols-1">
          <div className="">
            <h2 className="text-2xl text-start md:text-center font-bold  text-zinc-50">
              Get PDF before flying Nepal
            </h2>
            <p className="mt-2 text-[15px]  md:text-center text-gray-400">
              Get PDF before flying Nepal Experience the world class tour
