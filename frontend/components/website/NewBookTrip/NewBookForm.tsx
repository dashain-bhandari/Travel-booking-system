...
export default function NewBookForm({ expeditionId }: any) {
  ...
  const updateMaxQuantity = async (bookingUpdate: any) => {
    console.log("max quan called")
    console.log("booking",bookingUpdate)
    if (bookingUpdate?.departure ) {
      console.log("booking",bookingUpdate)
      const total= Number(bookingUpdate?.adults) + Number(bookingUpdate?.childrens)
      console.log(total)
      try {
        const { data } = await AxiosInstance.patch(`groupDeparture/${bookingUpdate?.groupDeparture?.groupDepartureId}`, {
          total
        })
        console.log(data)
      } catch (error: any) {
  ...
  console.log("expedition data", expedition);
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (bookingRes.status === 201) {
       ...
       // updateMaxQuantity(bookingRes?.data?.data)
  ...
  //promocode
  const [showPromo, setPromo] = useState<Boolean>(false);
  const showPromocode = () => {
    setPromo(!showPromo);
  };
  ...
  // Update the displayCount whenever the form values change
  useEffect(() => {
    const total = form.watch("childrens") + form.watch("adults");
    setDisplayCount(total);
  }, [form.watch("childrens"), form.watch("adults")]);

  const [viewDetails, setViewDetails] = useState(
    Array(displayCount).fill(false)
  );

  // Function to handle the opening/closing of individual detail forms
  const openIndividualDetail = (index: number) => {
    // Toggle the specific index in the array
    const updatedViewDetails = [...viewDetails];
    updatedViewDetails[index] = !updatedViewDetails[index];
  ...
  return (
    <>
      <div className="w-full relative  flex justify-center text-center items-center h-[70vh]">
        ...
        <div className="w-[95%] title  font-primary z-10 md:w-[80%] font-black text-2xl pt-[5rem] flex flex-col gap-2 text-white title relative  md:text-5xl  text-center justify-center items-center">
          Book your
          ...
          <div className="text-normal-paragraph-md  bg-yellow-500 bg-opacity-20 p-3 px-5 rounded-md  text-left ml-auto w-fit text-text-light">
            <p className="mt-1">
            ...
            <p>
              <span className="font-semibold">
                {" "}
                Starts in {expedition?.startPoint}:{" "}
              </span>{" "}
              {departure?.startDate}
            </p>
            <p className="mt-1">
            ...
            <p className="mt-1">
              {" "}
              <span className="font-semibold">What&apos;s included: </span> N/A
            </p>
            {/* <p className="mt-1">
              {" "}
      ...
      <div className="3xl:max-w-7xl mx-auto pb-[3rem]  ">
        <Form {...form}>
          ...
          >
            <div className="grid grid-cols-12 rounded-lg bg-[#FFFFFF]  p-2  md:px-16 md:py-10 my-[2rem] w-11/12  lg:w-10/12 mx-auto gap-5  ">
              <div className="col-span-8 mx-auto   w-full  rounded-sm ">
                <div className="flex  lg:flex-row flex-col gap-3 justify-center items-center mb-4 w-full">
                  <FormField
                ...
                <div className="flex lg:flex-row flex-col gap-3 w-full justify-center items-center mb-4">
                  {/* <FormField
                    control={form.control}
                    name="postalCode"
                    render={({ field }) => (
                ...
                <div className="flex flex-col lg:flex-row gap-2 mb-4 display-hidden">
                  {/* {childrenDiscounts && (
                    <>
                      <FormField
                        control={form.control}
                ...
                {displayCount > 1 && (
                  <div className="mt-5">
                    {Array.from({ length: displayCount - 1 }, (_, index) => (
                      <div
                        key={index}
                        className=" w-full gap-3 justify-center items-center font-primary"
                      >
                        <span
                          onClick={() => openIndividualDetail(index)}
                          className="flex mb-3 text-primary-btn  font-semibold cursor-pointer "
                        >
                        ...
                        {viewDetails[index] && (
                          <>
                            <div
                              className="flex  lg:flex-row flex-col gap-3 justify-center items-center mb-4 w-full"
                              key={index}
                            >
                              <FormField
                                control={form.control}
                                name="fullName"
                                // name={`fullName_${index}`} for future reference
                                render={({ field }) => (
                                  <FormItem className="w-full">
                                    <FormLabel className="font-semibold">
                                      Full Name{" "}
              ...
              <div className="col-span-4  flex w-full relative flex-col">
                            ...
                            render={({ field }) => (
                              <FormItem className="w-full ">
                                ...
                                <div className="grid grid-cols-2 items-center gap-7">
                                  ...
                                  <div className=" flex shadow-sm  border rounded-md overflow-hidden space-x-2 ">
                                    <button
                                      type="button"
                                      onClick={() =>
                                        // field.onChange(
                                ...
                                <div className="flex  ">
                                  {/* <span className="font-semibold text-[14px] mt-3">
                                    Trip Price for Adults:
                                  </span> */}
                                  <div className="text-[14px] font-semibold text-yellow-500">
                                    {form.watch("adults")} * $
                                    {discountedPricePerAdult
                                      ? discountedPricePerAdult
                                      : pricePerAdult}{" "}
                                  </div>
                                  <div className="font-semibold text-sm text-zinc-700 ml-auto">
                              ...
                              <div className="">
                                <FormLabel className="text-base font-semibold">
                                  <span
                                    ...
                                    className="cursor-pointer text-primary-btn"
                                  >
                                    Redeem Promo Code
                                  </span>
                                </FormLabel>
                                  ...
                                  render={({ field }) => {
                                    return (
                                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                                        <div className="flex flex-col-2 gap-2 w-full">
                                          <FormControl>
                                            <Input
                                              disabled={
                                              ...
                                              {...field}
                                              className={` ${isPromoAvailable === "true"
                                          ...
                                          <button
                                            ...
                                            onClick={() => applyPromo()}
                                            className={`text-white  w-fit     font-medium rounded-md text-sm px-10 py-2.5 text-center me-2  flex items-center gap-1 ${isPromoAvailable === "true"
                                                ? "bg-green-400"
