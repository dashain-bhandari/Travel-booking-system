...
import { authenticateToken, createRoleSpecificUserHandler, createUserHandler, deleteUserHandler, getAllUserExceptAdminHandler, getAllUserHandler, getRoleSpecificUserHandler, getUserAvailabilityHandler, getUserByUsernameHandler, getUserFromTokenHandler, getUserHandler, loginUserHandler, updatePasswordHandler, updateRoleSpecificUserHandler, updateUserHandler, updateUserPasswordByAdminHandler, verifyEmailHander } from "../controller/user.controller";
 ...
 */
router.post("/register-special-user", [validate(createUserSchema),requireAdmin], createRoleSpecificUserHandler);
 ...
 */
router.patch("/role/:userId", [validate(updateUserSchema)], updateRoleSpecificUserHandler);
 ...
 *         description: User not found
 */
router.patch("/password/:userId", [validate(updateUserSchema)], updateUserPasswordByAdminHandler);
