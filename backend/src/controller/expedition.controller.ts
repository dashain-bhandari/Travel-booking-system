...
import { createExpedition, findExpedition, findAndUpdateExpedition, deleteExpedition, findAllExpedition, findAllExpeditionByType, findAllExpeditionByMeter, findAllUpcomingExpedition, findAllUpcomingTrekking, findManyExpedition, findAllExpeditionWithoutPopulate, deleteManyExpedition } from "../service/expedition.service";
...
export async function getExpeditionHandler(req: Request<UpdateExpeditionInput["params"]>, res: Response, next: NextFunction) {
  try {
    const expeditionId = req.params.expeditionId;
    const expedition = await findExpedition({$or:[{expeditionId},{slug:expeditionId}]  });
...
export async function getExpeditionFromCategoryHandler(req: Request<findExpeditionFromCategoryInput["params"]>, res: Response, next: NextFunction) {
  try {
    ...
    const expedition = await findManyExpedition({$and:[{ category: { $eq: categoryId } },{isPublished:true}]});
...
export async function getExpeditionFromCategoryDashboardHandler(req: Request<findExpeditionFromCategoryInput["params"]>, res: Response, next: NextFunction) {
  try {
    const categoryId = req.params.categoryId;
...
export async function deleteManyExpeditionHandler(req: Request, res: Response, next: NextFunction) {
  try {
    console.log("hii")
   if(req.body.id){
